...
import com.example.quizkit.ui.component.EmailInputForm
import com.example.quizkit.ui.component.InputForm
import com.example.quizkit.ui.component.PasswordInputForm
...
fun RegisterScreen(navController: NavController, authViewModel: AuthViewModel = koinViewModel()) {
    ...
    Scaffold(
        ...
        Column(
            ...
            EmailInputForm(title = "Email Address", value = email, icon = R.drawable.email, onChange = {
                email = it
            })
            PasswordInputForm(title = "Password", value = password, icon = R.drawable.lock, onChange = {
                password = it
            })
